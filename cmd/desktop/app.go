...
func (a *App) AddEndpoint(name, apiUrl, apiKey, authMode, transformer, model, reasoningEffort, remark string) error {
	return a.endpoint.AddEndpoint(name, apiUrl, apiKey, authMode, transformer, model, reasoningEffort, remark)
}
func (a *App) RemoveEndpoint(index int) error { return a.endpoint.RemoveEndpoint(index) }
func (a *App) UpdateEndpoint(index int, name, apiUrl, apiKey, authMode, transformer, model, reasoningEffort, remark string) error {
	return a.endpoint.UpdateEndpoint(index, name, apiUrl, apiKey, authMode, transformer, model, reasoningEffort, remark)
}
