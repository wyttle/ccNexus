...
func (e *EndpointService) AddEndpoint(name, apiUrl, apiKey, authMode, transformer, model, reasoningEffort, remark string) error {
...
func (e *EndpointService) UpdateEndpoint(index int, name, apiUrl, apiKey, authMode, transformer, model, reasoningEffort, remark string) error {
	endpoints := e.config.GetEndpoints()
